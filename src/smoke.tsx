...
const data: Row[] = [
  ...
  { port: 5173, ports: [5173, 55725, 55727], pid: 52890, command: 'node /p/dash/node_modules/vite/bin/vite.js', framework: 'Vite', project: 'dashboard-frontend', cpu: null, memMB: 96, uptimeSecs: 50 },
